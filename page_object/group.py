...
class Group:
    ...
    def create(self):
        ...
        self.page.fill('input[name="group_name"]', "playwright_name")
        self.page.fill('textarea[name="group_header"]', "playwrith_header")
        self.page.fill('textarea[name="group_footer"]', "playwright_footer")
